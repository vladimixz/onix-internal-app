...
import { SecureStore, Svg } from 'expo';
...
export default class Home extends React.Component {
  ...
  constructor(props) {
    ...
    if (params && params.redirect) {
      this.props.navigation.navigate(params.redirect);
    }
  }
